...
{var field=$(this);field.removeClass('fl-form-error');field.siblings('.fl-form-error-message').hide();}};$(function(){FLBuilderLayout.init();});})(jQuery);jQuery('.optin-open-modal a').attr('rel','ck_modal');jQuery('.single-post .post-image').wrap('<div class="post-image-container"></div>');