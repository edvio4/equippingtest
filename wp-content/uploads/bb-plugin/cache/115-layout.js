...
{var field=$(this);field.removeClass('fl-form-error');field.siblings('.fl-form-error-message').hide();}};$(function(){FLBuilderLayout.init();});})(jQuery);jQuery('.optin-open-modal a').attr('rel','ck_modal');jQuery('.single-post .post-image').wrap('<div class="post-image-container"></div>');jQuery('.nav-primary').after('<div class="fl-builder-content fl-builder-content-primary fl-builder-global-templates-locked focus-area"></div>');jQuery('.focus-area').prepend(jQuery(".fl-row[data-node='5907dad59344a']"));