...
var wpAjaxUrl='http://equippingourkids.com/wp-admin/admin-ajax.php';var flBuilderUrl='http://equippingourkids.com/wp-content/plugins/bb-plugin/';var FLBuilderLayoutConfig={anchorLinkAnimations:{duration:1000,easing:'swing',offset:100},paths:{pluginUrl:'http://equippingourkids.com/wp-content/plugins/bb-plugin/',wpAjaxUrl:'http://equippingourkids.com/wp-admin/admin-ajax.php'},breakpoints:{small:768,medium:992},waypoint:{offset:80}};(function($){if(typeof FLBuilderLayout!='undefined'){return;}
...
{var field=$(this);field.removeClass('fl-form-error');field.siblings('.fl-form-error-message').hide();}};$(function(){FLBuilderLayout.init();});})(jQuery);jQuery('.optin-open-modal a').attr('rel','ck_modal');jQuery('.single-post .post-image').wrap('<div class="post-image-container"></div>');(function($){FLBuilderPostGrid=function(settings)
...
if(this._hasPosts()){this._initLayout();this._initInfiniteScroll();}};FLBuilderPostGrid.prototype={settings:{},nodeClass:'',wrapperClass:'',postClass:'',gallery:null,_hasPosts:function()
...
else if(this.settings.layout=='gallery'){this.gallery.resize();elements.css('visibility','visible');}}};})(jQuery);(function($){$(function(){new FLBuilderPostGrid({id:'58ec3c530e503',layout:'grid',pagination:'scroll',postSpacing:'50',postWidth:'700',matchHeight:0});});$(window).on('load',function(){$('.fl-node-58ec3c530e503 .fl-post-grid').masonry('reloadItems');});})(jQuery);